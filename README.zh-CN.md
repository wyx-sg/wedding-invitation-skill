...
1. **对话** — Claude 问你的语言、姓名、日期、场地
2. **挑风格方向** — Claude 看你的照片挑出 5 个最匹配的方向，浏览器里展示；可单选可多选
3. **设计** — Claude 为每个你挑的方向都从零写一份 HTML 模板
4. **打开 gallery** — `dist/index.html` 在浏览器里打开，每张设计都是一张卡片，点进去可查看、下载（Social 1080×1440 / Print 2160×2880）、或在 tweak 面板里实时切配色字体相框
5. **对话里迭代** — tweak 面板搞不定的（"字大点""换照片""重写排版"），跟 Claude 说就行
